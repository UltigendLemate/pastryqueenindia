...
const org = () => {
  ...
  return (
    ...
    <motion.div ref={ref}
      ...
      }} className=" bg-opacity-5  bg-center bg-cover backdrop-blur-2xl relative"  >
      <img src="/pics/IMG_3980.webp" className='blur-sm opacity-50 shadow-2xl shadow-black absolute w-full h-full -z-20' alt="" />
