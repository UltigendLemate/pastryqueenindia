        ...
        <div className='bg-white text-black flex items-center flex-col'>
            <Marquee speed={180}>
                <div className='flex flex-row justify-center align-middle'>
                    <h1 className='mx-10 text-4xl text-[#e100c5] my-auto font-BebasNeue font-semibold'>DIAMOND SPONSORS </h1>
                    <Image alt='' src={Diamond} height={60} width={60} />
                </div>
                <div className='flex flex-row justify-center align-middle '>
                    <h1 className='mx-10 text-4xl text-[#e100c5] my-auto font-BebasNeue font-semibold'>DIAMOND SPONSORS </h1>
                    <Image alt='' src={Diamond} height={60} width={60} />
                </div>
                <div className='flex flex-row justify-center align-middle font-BebasNeue'>
                    <h1 className='mx-10 text-4xl text-[#e100c5] my-auto font-BebasNeue font-semibold'>DIAMOND SPONSORS </h1>
                    <Image alt='' src={Diamond} height={60} width={60} />
                </div>
                <div className='flex flex-row justify-center align-middle font-BebasNeue'>
            ...
            <div className='flex flex-col items-center justify-center my-4 w-fit pr-4 rounded-lgm mx-4'>
                ...
                <div className='flex flex-col align-middle text-center justify-center mx-4'>
                    <div className='text-3xl my-4 text-[#e100c5] font-bold'>TATA LG</div>
