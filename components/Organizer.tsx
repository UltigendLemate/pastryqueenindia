...
const Organizer = (props : Props) => {
  ...
  return (
    ...
    {showModal && (
                <div className="fixed w-screen h-screen  top-0 left-0 z-[99999999] flex items-center justify-center bg-white bg-opacity-10 backdrop-blur-md overflow-hidden">
                    <div className="bg-white rounded-lg shadow-l z-[999] p-4 pt-0 md:pt-0 md:p-6 max-w-[250px] max-h-[400px] md:max-w-3xl md:max-h-[500px] overflow-hidden relative  w-full">
