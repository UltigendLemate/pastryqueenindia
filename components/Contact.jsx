                ...
                <div className="container mx-auto max-w-screen-xl">
                  ...
                  "
                                ...
                                <p className="text-base text-body-color leading-relaxed mb-9">
                                    Get connected to us just with an E-mail, and get us through your doubts, queries, problems and suggestions
                                </p>
                        ...
                        <div className="w-full lg:w-1/2 xl:w-5/12 px-4 mx-2 md:mr-10">
