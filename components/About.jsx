    ...
    <section ref={ref} id='About' className='bg-white font-mon text-black flex items-center flex-col max-w-screen-xl mx-auto px-5 '>
      ...
      <motion.div className='grid md:grid-cols-2 gap-10 py-10' ref={ref2}
        ...
        variants={{
          ...
          <div>
          <img src="/images/DSC_8053.jpg" alt="" className='rounded-md max-h-96 object-cover hidden md:block' />
        ...
        {/* ref={ref} width={600} height={600}
            ...
            <img src="/images/DSC_7840.JPG" alt="" className='rounded-md max-h-96 object-cover hidden md:block' />
            </div>
